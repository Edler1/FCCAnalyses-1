if [ "${0}" != "${BASH_SOURCE}" ]; then
  if [ -z "${KEY4HEP_STACK}" ]; then
    ...
    #source /cvmfs/sw.hsf.org/spackages6/key4hep-stack/2022-10-27/x86_64-centos7-gcc11.2.0-opt/2qr6e/setup.sh
    source /cvmfs/sw.hsf.org/spackages6/key4hep-stack/2022-10-30/x86_64-centos7-gcc11.2.0-opt/ysznw/setup.sh
  else
